#!/usr/bin/env python3
"""
Export Moonshine-streaming-small (v2) decoder WITHOUT state — cross-KV passed as inputs.
This bypasses the CoreML state mechanism which has issues writing cross-KV from Python/Swift.
"""
...
def export_nonstateful_decoder():
    print("-> Exporting non-stateful decoder (cross-KV as inputs)...")
