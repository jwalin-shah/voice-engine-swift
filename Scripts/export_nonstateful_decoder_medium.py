#!/usr/bin/env python3
"""
Export Moonshine-streaming-medium (v2) decoder WITHOUT state -- cross-KV passed as inputs.
Adapted from export_nonstateful_decoder.py (streaming-small) for streaming-medium.
"""
...
# medium: NL=14, H=10, D=64, DEC_HID=640, ENC_HID=768, ROT_DIM=32
NL, H, D = 14, 10, 64
DEC_HID, ENC_HID = 640, 768
...
def export_nonstateful_decoder():
    print("-> Exporting non-stateful decoder for streaming-medium (cross-KV as inputs)...")
